...
export function RoomPage() {
  ...
  if (room.phase === 'GAME_RESULTS') return <Suspense fallback={<GameLoadingFallback />}><gameClient.Results room={room} selfId={user.id} onLobby={() => void context.returnLobby()} onEnd={() => void context.endSession()} /></Suspense>;
