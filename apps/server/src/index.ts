...
import { apiRouter, registerGameImageResolver, registerPokemonRepository, registerTcgCardCatalog } from './http/routes.js';
...
import { PrismaTcgCardRepository } from './tcg/repository.js';
import { CachedTcgCardCatalog } from './tcg/comparable-price.js';
...
const tcgCards = new CachedTcgCardCatalog(new PrismaTcgCardRepository(prisma));
